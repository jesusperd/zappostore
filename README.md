...
- **Clientes** con perfil real en Supabase (auto-registro por teléfono, actualización de datos en pedidos siguientes) + ficha con total gastado y mini-gráfico.
