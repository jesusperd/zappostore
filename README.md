...
**Sigue (próximo):** migrar Vender/Seguimiento/Caja/Clientes/pagos de memoria a Supabase, RLS granular por rol para esas tablas, Storage para las fotos de diseño, Inventario/Stock, Gastos/Estadísticas.
